...
export const BookViewer: React.FC<BookViewerProps> = ({ book, onClose }) => {
  ...
  const [showMobileSearchAndZoom, setShowMobileSearchAndZoom] = useState(false);
  ...
  }, [currentPage, isRTL, nextPage, prevPage, onClose]);
  ...
  return (
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      ...
      <div className="bg-white border-b border-slate-200 px-4 md:px-6 py-3 md:py-4 flex items-center justify-between flex-wrap gap-2">
        ...
        {/* --- LEFT SIDE: Search & Zoom Controls / Mobile Toggle --- */}
        {/* This group will be on the left */}
        <div className="flex items-center gap-2 md:gap-4 order-1"> {/* order-1 makes it first (left) */}
          {/* Desktop Search & Zoom Controls */}
        ...
        {/* --- RIGHT SIDE: Book Info + Close Button --- */}
        {/* This group will be on the right */}
        <div className="flex items-center gap-2 md:gap-4 order-2 ml-auto"> {/* order-2 makes it second (right), ml-auto pushes it */}
          <div className="min-w-0 text-right"> {/* text-right for Hebrew content */}
        ...
        {/* Mobile Search & Zoom Controls (shown when toggled, full width) */}
        {showMobileSearchAndZoom && (
            <div className="md:hidden w-full flex flex-col items-center gap-3 mt-2 pb-2 border-t border-slate-100 pt-2 order-3">
